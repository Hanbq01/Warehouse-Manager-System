...
public class RegisterFrame extends JFrame {
    private JLabel labTitle = new JLabel("仓库管理系统注册");
    ...
    private void init() {
        ...
        btnSure.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                // 判断输入是否为空
                if (name.equals("") || password.equals("") || addr.equals("")
                        || email.equals("") || phone.equals("")) {
                    JOptionPane.showMessageDialog(null, "信息输入不完整，请检查并重新输入", "提示",
                ...
                String sql = "select * from user where username='" + name
                        + "';";
                String sql2 = "insert into user(username,userpwd,useremail,useraddr,userphone) value('"
                        + name
                        + "','"
                        + password
                        + "','"
