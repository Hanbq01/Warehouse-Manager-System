...
public class Good_Update_Delete extends JFrame {
	...
	private JLabel jLabel3 = new JLabel("货物出货地：");
	private JLabel jLabel4 = new JLabel("货物类型：");
	...
	public Good_Update_Delete() {
		this.setSize(600, 500);
		setTitle("货物信息修改与删除");
		setLocationRelativeTo(null);
		setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);

		model = new MyModel("select * from goods;");
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				String id, name, type, writter, price, num;
		...
		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (result == JOptionPane.YES_OPTION) {
					Statement stmt = DBUtil.getStatement();
					String sql = "delete from goods where GoodsId = " + i + ";";
					try {
						stmt.executeUpdate(sql);
