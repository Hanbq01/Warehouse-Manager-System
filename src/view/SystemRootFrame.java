...
public class SystemRootFrame extends JFrame {
	...
	public SystemRootFrame() {
		this.setLayout(null);
		ImageIcon img = new ImageIcon("image/780.jpg");
		// 要设置的背景图片
		...
		JMenuItem J1_1 = new JMenuItem("添加货物");
		J1_1.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				new GoodAddFrame().setVisible(true);
			}
		});

		JMenuItem J1_2 = new JMenuItem("更新和删除货物");
		J1_2.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				new Good_Update_Delete().setVisible(true);
			}
		});

		JMenuItem J1_3 = new JMenuItem("查找货物");
		...
		JMenuItem J1_4 = new JMenuItem("查看所有货物");
		...
		JMenu j3 = new JMenu("货物记录");
		JMenu J3 = new JMenu("货物数据分析");
		...
		JMenuItem j3_1 = new JMenuItem("查看出货记录");
		j3_1.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent arg0) {
				new AllOut().setVisible(true);
			}
		});
		J3.add(J3_1);
		J3.add(J3_2);
		...
		j4_1.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent arg0) {
				new RootChangePWD().setVisible(true);
			}
		});
