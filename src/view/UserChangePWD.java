	...
	public UserChangePWD() {
		...
		jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String username = SystemUserFrame.USER_NAME;// 获取当前登录用户名

				Statement stmt = DBUtil.getStatement();
				String sql = "update user set userPWD ='" + New + "' where userName = '" + username + "';";
				String sql2 = "select * from user where userName='" + username + "' AND userPWD='" + Old + "';";
				try {
